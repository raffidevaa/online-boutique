...
| AIOpsLab | Observer | `research/observer/` | Read-only Prometheus, Loki, and alerts adapters; `service/` supplies Docker state | Cluster-specific observability | Docker state is the relevant runtime evidence. |
